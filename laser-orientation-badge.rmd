...
-   quiz data and how much time each student spent

-   there are the lastthree  columns that are not clear at this point
...
-   cases or individual students in my research

What columns typically (or you think may) represent:

-   variables, i.e., grades
...
-  Cases changed from 438 rows to 510 rows meaning 510 students went cut-off from 50 
